...
<jsp:useBean id="sampleCalculatorServiceImplProxyid" scope="session" class="com.calculator.service.CalculatorServiceImplProxy" />
<%
...
case 10:
        gotMethod = true;
        com.calculator.service.CalculatorServiceImpl getCalculatorServiceImpl10mtemp = sampleCalculatorServiceImplProxyid.getCalculatorServiceImpl();
...
case 13:
        ...
        int addValue13mtemp = sampleCalculatorServiceImplProxyid.addValue(a_1idTemp,b_2idTemp);
...
case 20:
        ...
        int subtractValue20mtemp = sampleCalculatorServiceImplProxyid.subtractValue(a_3idTemp,b_4idTemp);
        String tempResultreturnp21 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(subtractValue20mtemp));
        %>
        <%= tempResultreturnp21 %>
        <%
break;
case 27:
        ...
        int multiplyValue27mtemp = sampleCalculatorServiceImplProxyid.multiplyValue(a_5idTemp,b_6idTemp);
        String tempResultreturnp28 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(multiplyValue27mtemp));
        %>
        <%= tempResultreturnp28 %>
        <%
break;
