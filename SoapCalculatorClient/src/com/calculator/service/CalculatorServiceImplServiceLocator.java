...
public class CalculatorServiceImplServiceLocator extends org.apache.axis.client.Service implements com.calculator.service.CalculatorServiceImplService {
    ...
    private java.lang.String CalculatorServiceImpl_address = "http://localhost:8080/SoapCalculator/services/CalculatorServiceImpl";
    ...
    public com.calculator.service.CalculatorServiceImpl getCalculatorServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public com.calculator.service.CalculatorServiceImpl getCalculatorServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.calculator.service.CalculatorServiceImplSoapBindingStub _stub = new com.calculator.service.CalculatorServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.calculator.service.CalculatorServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.calculator.service.CalculatorServiceImplSoapBindingStub _stub = new com.calculator.service.CalculatorServiceImplSoapBindingStub(new java.net.URL(CalculatorServiceImpl_address), this);
                _stub.setPortName(getCalculatorServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.calculator.com", "CalculatorServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.calculator.com", "CalculatorServiceImpl"));
        }
